  ...
  return (
    <MainContainer>
      <Projects>
        ...
        <ProjectContent>
          <PContentTitle>Breakfast App <Icon size={"medium"}> <SocialMedia href={"https://github.com/andresfelipear/MERN-APP2"}><FontAwesomeIcon size='1x' icon={faGithub} /></SocialMedia> </Icon></PContentTitle>
      ...
      <Projects>
        ...
        <ProjectContent>
          <PContentTitle>Travel Blog <Icon size={"medium"}> <SocialMedia href={"https://github.com/andresfelipear/NodeJS-FinalProyect"}><FontAwesomeIcon size='1x' icon={faGithub} /></SocialMedia> </Icon></PContentTitle>
      ...
      <Projects>
        ...
        <ProjectContent>
          <PContentTitle>World Holidays <Icon size={"medium"}> <SocialMedia href={"https://github.com/andresfelipear/REACT-APP3"}><FontAwesomeIcon size='1x' icon={faGithub} /></SocialMedia> </Icon></PContentTitle>
