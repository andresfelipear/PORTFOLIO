  ...
  return (
    <Footer
            ...
            <div className="is-flex pr-4">
              <Icon size={'large'}>
                ...
                <Nets
                  target={'_blank'}
                  href={
                    'https://www.linkedin.com/in/andres-felipe-arevalo-suarez-a80529102/'
                  }>
              ...
              <Icon size={'large'}>
                ...
                <Nets
                  target={'_blank'}
                  href={'https://github.com/andresfelipear'}>
              ...
              <Icon size={'large'}>
                ...
                <Nets
                  target={'_blank'}
                  href={'https://www.facebook.com/andres.f.suarez.52/'}>
              ...
              <Icon size={'large'}>
                ...
                <Nets
                  target={'_blank'}
                  href={'https://www.instagram.com/andresarevalo12/'}>
      ...
      <p
        ...
        Copyright © 2025 • All rights reserved • Andres Arevalo
      </p>
    </Footer>
  )
}
